    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-3">
          ...
          <div><Label className="text-xs">Status / Response</Label><Textarea value={form.status_response} onChange={e => setForm({ ...form, status_response: e.target.value })} rows={3} placeholder="Detailed summary of the conversation..." /></div>
